# -*- coding: utf-8 -*-
"""
Created on Fri May 14 17:17:10 2021

@author: luismiguells

Description: Extract different statistics from the datasets: Covid Dataset, 
...
# Features file names
feat_files = ['split/words.txt', 'split/emoticons.txt', 'split/hashtags.txt', 'split/ats.txt', 'split/links.txt', 'split/abvs.txt']
