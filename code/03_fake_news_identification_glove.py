...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 10 17:52:21 2021
...
Using GloVe vectors to tranform the data. SVM, LR, SGDC, MNB, KNN and 
...
# Choose the correct file for the corresponding language 
if lang == 'spanish':
    glove_file = 'C:/Users/luismiguel/Google Drive/MT/data/pre_trained_models/glove_spanish_300.vec'
else:
    glove_file = 'C:/Users/luismiguel/Google Drive/MT/data/pre_trained_models/glove_english_200.txt'
...
# Size of 300 for Spanish and 200 for English 
if lang == 'spanish':
    n = 300
else:
    n = 200
...
# Normalize the data
n, m = gv_corpus.shape
min_values = np.min(gv_corpus, axis=1)
...
for cl in classifiers:
    ...
    for train_index, test_index in skf.split(gv_corpus, labels):
        print('Fold :',i)
        data_train = [gv_corpus[x] for x in train_index]
        data_test = [gv_corpus[x] for x in test_index]
