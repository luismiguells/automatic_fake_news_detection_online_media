# -*- coding: utf-8 -*-
"""
Created on Fri Oct 15 14:15:44 2021

@author: luismiguells

Description: Extract different statistics from the datasets: Fake News Corpus 
Spanish dataset
"""
...
# Features file names
feat_files = ['split_train/words.txt', 'split_train/emoticons.txt', 'split_train/hashtags.txt', 'split_train/ats.txt', 'split_train/links.txt', 'split_train/abvs.txt']
...
for feat in range(6):
    if feat == 0:
        ...
        corpus = read_text_data(lang, main_dir+feat_files[feat])
        print('Feature data loaded!')
    else:
        print('Loading feature data...')
        corpus = read_data(main_dir+feat_files[feat])
        print('Feature data loaded!')
