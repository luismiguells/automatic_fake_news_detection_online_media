# -*- coding: utf-8 -*-
"""
Created on Fri May 28 14:16:00 2021
...
to tranform the data. SVM, LR, SGDC, MNB, KNN and RF are the models
...
for cl in classifiers:
    ...
    if classifier == 'SVM':
        ...
        for c in cs:
            ...
            score = val_score(clf_inner, gv_corpus_train, labels_train, gv_corpus_valid, labels_valid)
            if score > best_score:
                best_score = score
                best_c = c
