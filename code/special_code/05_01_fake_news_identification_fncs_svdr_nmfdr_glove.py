# -*- coding: utf-8 -*-
"""
Created on Mon May 31 09:00:11 2021
...
for cl in classifiers:
    ...
    if classifier == 'SVDR':
        ...
        for n in ns:
            ...
            scores_inner = []
            for sub_train_index, sub_test_index in sub_skf.split(gv_corpus_train, labels_train):
                sub_data_train, sub_data_test = gv_corpus_train[sub_train_index], gv_corpus_train[sub_test_index]
        ...
        pcadr = train_pca(gv_corpus_train, labels_train, labels_set_train, best_n)
        ...
        # Traing with the best hyper-parameter
        nmfdr = train_nmf(gv_corpus_train, labels_train, labels_set_train, best_n)
