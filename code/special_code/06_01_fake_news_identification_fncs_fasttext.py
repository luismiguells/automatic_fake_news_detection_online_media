# -*- coding: utf-8 -*-
"""
Created on Sat Jun  5 12:28:29 2021
...
for cl in classifiers:
    ...
    if classifier == 'SVM':
        ...
        for c in cs:
            ...
            scores_inner = cross_val_score(clf_inner, ft_corpus_train, labels_train, scoring='f1_macro', cv=sub_skf)
    ...
    clf.fit(ft_corpus_train, labels_train)
