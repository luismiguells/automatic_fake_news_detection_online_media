# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 12:01:29 2021
...
for cl in classifiers:
    ...
    if classifier == 'SVDR':
        ...
        for n in ns:
            sub_svdr = train_pca(w2v_corpus_train, labels_train, labels_set_train, n)
            sub_predicted, temp_scores = predict_pca(w2v_corpus_valid, sub_svdr)
        ...
        for n in ns:
            sub_nmfdr = train_nmf(w2v_corpus_train, labels_train, labels_set_train, n)
            sub_predicted, temp_scores = predict_nmf(w2v_corpus_valid, sub_svdr)
            score = metrics.f1_score(labels_valid, sub_predicted, average='macro')
            if score > best_score:
                best_score = score
                best_n = n
