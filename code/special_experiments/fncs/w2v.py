...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 12 17:46:43 2021
...
w2v_file = project_root / 'data' / \'pre_trained_models/word2vec_spanish_300.txt'
...
classifiers = ['SVM', 'LR', 'SGDC', 'KNN', 'RF']
...
for cl in classifiers:
    ...
    if classifier == 'SVM':
        ...
        for c in cs:
            ...
            scores_inner = cross_val_score(clf_inner, w2v_corpus_train, labels_train, scoring='f1_macro', cv=sub_skf)
    ...
    clf.fit(w2v_corpus_train, labels_train)
